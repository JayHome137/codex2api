...
func TestChannelMonitorConfigHistoryLifecycle(t *testing.T) {
	...
	if config.Enabled || config.NextCheckAt.Valid {
...
func TestChannelMonitorPostgresLifecycle(t *testing.T) {
	...
	if !config.NextCheckAt.Valid || config.Status != ChannelMonitorStatusOperational {
